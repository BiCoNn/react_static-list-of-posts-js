...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({post:e={}})=>{const{comment:t}=e;return R.jsxs("div",{className:"CommentInfo",children:[R.jsxs("div",{className:"CommentInfo__title",children:[R.jsx("strong",{className:"CommentInfo__name",children:t.name})," by ",R.jsx("a",{className:"CommentInfo__email",href:`mailto:${t.email}`,children:t.email})]}),R.jsx("div",{className:"CommentInfo__body",children:t.body})]})},Lc=({comments:e})=>e.length>0?R.jsx("div",{className:"CommentList",children:e.map(i=>R.jsx(Pc,{post:{comment:i}},i.id))}):R.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"}),Tc=({user:e})=>R.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Mc=({post:e})=>R.jsxs("div",{className:"PostInfo",children:[R.jsxs("div",{className:"PostInfo__header",children:[R.jsx("h3",{className:"PostInfo__title",children:e.title}),R.jsxs("p",{children:[" Posted by  ",R.jsx(Tc,{user:e.user})]})]}),R.jsx("p",{className:"PostInfo__body",children:e.body}),R.jsx("hr",{}),R.jsx(Lc,{comments:e.comments})]}),Rc=({posts:e})=>R.jsx(R.Fragment,{children:e.map(t=>R.jsx(Mc,{post:t},t.id))}),Dc=Cc.map(e=>{const t=Nc.find(n=>n.id===e.userId),i=zc.filter(n=>n.postId===e.id);return{...e,user:t,comments:i}}),jc=()=>R.jsxs("section",{className:"App",children:[R.jsx("h1",{className:"App__title",children:"Static list of posts"}),R.jsx("div",{className:"PostList",children:R.jsx(Rc,{posts:Dc})})]});em(document.getElementById("root")).render(R.jsx(jc,{}));
